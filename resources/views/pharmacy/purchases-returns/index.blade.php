...
<div class="container my-3">
    <div class="flex justify-between items-center">
        ...
        <a class="bg-green-700 hover:bg-green-800 white-text py-2 px-4 text-white shadow-sm" href="{{url('pharmacy/purchases/'.$order->uuid.'/returns/create')}}">Create</a>
    </div>
</div>
<div class="container">
...
<div class="container">
    @include('pharmacy.purchases-returns.table')
</div>
