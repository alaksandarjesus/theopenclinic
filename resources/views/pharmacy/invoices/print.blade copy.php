    ...
    <table class="table-auto w-full">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="mb-1"><strong>Phone: </strong>{{$invoice->customer->phone}}</div>
            </td>
        </tr>
    </table>
</div>
    ...
    <table class="table-auto w-full">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right border border-gray-1 p-4">{{$invoice->subtotal?$invoice->formatted->subtotal:'0.00'}}</td>
            </tr>
            <tr>
                <th class="text-right border border-gray-1 p-4" colspan="6">Tax</th>
                <td class="text-right border border-gray-1 p-4">{{$invoice->tax?$invoice->formatted->tax:'0.00'}}</td>
            </tr>
            <tr>
                <th class="text-right border border-gray-1 p-4" colspan="6">Discount</th>
                <td class="text-right border border-gray-1 p-4">{{$invoice->discount?$invoice->formatted->discount:'0.00'}}</td>
            </tr>
            <tr>
                <th class="text-right border border-gray-1 p-4" colspan="6">Total</th>
                <td class="text-right border border-gray-1 p-4">{{$invoice->total?$invoice->formatted->total:'0.00'}}</td>
            </tr>
            <tr>
                <td colspan="7">
